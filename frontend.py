...
class ThirdPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        w2 = tk.Label(self, text="BIRD vs DRONE CLASSIFICATION", bg="orange"  ,fg="white"  ,width=30  ,height=1,font=('times', 24, 'italic bold underline'))
        w2.place(x=400,y=10)  
        ...
        l.place(x=200,y=200)
        '''
        k=tk.Button(self,text="Browse For Input Image", command=self.showImgg, bg="blue"  ,fg="white"  ,width=20  ,height=1,font=('times', 20, 'italic bold underline'))
        k.place(x=800,y=200)
        
        t=tk.Button(self,text="Classify Test Image", command=self.Classify, bg="blue"  ,fg="white"  ,width=20  ,height=1,font=('times', 20, 'italic bold underline'))
        t.place(x=800,y=300)
        ...
        Button = tk.Button(self, text="Back",bg = "dark orange", font=("Arial", 15), command=lambda: controller.show_frame(ThirdPage))
    ...
    def Classify(self):
        ...
        #model = load_model('ALL_model4.h5')
        ...
        test_image = image.load_img(self.load,target_size = (500,500,3))
...
# Assign label based on the index with the highest probability
        if result[0] > 0.5:
            a = "drone"
        else:
            a = " bird"
        ...
        s.place(x=850,y=500)
    def showImgg(self):
        self.load = askopenfilename(filetypes=[("Image File",'.png .jpeg .jpg')])
...
class Application(tk.Tk):
    ...
    def show_frame(self, page):
        ...
        frame.tkraise()
        self.title(" Project Name Application")
